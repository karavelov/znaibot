...
<div class="p-6 sm:p-10 space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-black tracking-tight text-gray-900 dark:text-white">Редактиране на категория</h1>
            <p class="text-gray-400 dark:text-gray-500 text-sm font-medium mt-1">{{ $category->name }}</p>
        </div>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <select name="status"
                        ...
                        <option {{ $category->status == 1 ? 'selected' : '' }} value="1">Публично</option>
                        <option {{ $category->status == 0 ? 'selected' : '' }} value="0">Скрито</option>
                    </select>
                </div>
