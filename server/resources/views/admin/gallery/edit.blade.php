...
<div class="p-6 sm:p-10 space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-black tracking-tight text-gray-900 dark:text-white">Редактиране на галерия</h1>
            <p class="text-gray-400 dark:text-gray-500 text-sm font-medium mt-1">{{ $gallery->title }}</p>
        </div>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <select name="status"
                        ...
                        <option {{ $gallery->status == 1 ? 'selected' : '' }} value="1">Публично</option>
                        <option {{ $gallery->status == 0 ? 'selected' : '' }} value="0">Скрито</option>
                    </select>
                </div>
