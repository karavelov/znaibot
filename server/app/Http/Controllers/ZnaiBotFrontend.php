...
class ZnaiBotFrontend extends Controller
{
    ...
    public function news()
    {
        ...
        return view('frontend.news', compact('featured', 'news'));
    }
    ...
    public function newsarticle($slug)
    {
        ...
        return view('frontend.newsarticle', compact('article'));
    }

    public function clubs()
    {
        $clubs = DB::table('clubs')->get();
        return view('frontend.clubs', ['clubs' => $clubs]);
    }

    public function clubsAchievements()
    {
        $clubs = DB::table('clubs')->whereNotNull('achievements')->get();
        return view('frontend.clubs_achievements', compact('clubs'));
    }
    ...
    public function clubsGallery($id)
    {
        ...
        return view('frontend.clubs_gallery', compact('gallery', 'galleries', 'galleriesimages'));
    }
    ...
    {
        return view('frontend.robohead');
    }

    public function studentHome()
    {
        return view('frontend.student_home', ['user' => $this->getScannedUser()]);
    }

    public function studentChat()
    {
        return view('frontend.student_chat', ['user' => $this->getScannedUser()]);
    }

    public function studentFindteacher()
    {
        return view('frontend.student_findteacher', ['user' => $this->getScannedUser()]);
    }
    ...
    public function studentLostthings()
    {
        ...
        return view('frontend.student_lostthings', [
            'items' => $items,
    ...
    public function studentQuiz()
    {
        ...
        return view('frontend.student_quiz', ['question' => $question, 'user' => $user, 'answered' => false, 'attemptsLeft' => $attemptsLeft]);
    }
    ...
    public function parentHome()
    {
        ...
        return view('frontend.parent_home', [
            'parent' => $parent,
            'child' => $child
        ]);
    }
    ...
    {
        return view('frontend.parent_events');
    }

    public function parentClassroom()
    {
        return view('frontend.parent_classroom');
    }

    public function parentRoute()
    {
        return view('frontend.parent_route');
    }
