    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('Действие', function($query){
                ...
                $deleteBtn = "<a href='".route('admin.footer-socials.delete', $query->id)."' class='btn btn-danger ml-2 delete-item'><i class='far fa-trash-alt'></i></a>";

                return $editBtn.$deleteBtn;
            })
            ->addColumn('Икона', function($query){
            ...
            ->rawColumns(['Икона', 'Действие', 'Статус'])
            ->setRowId('id');
    }
