...
class GalleryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('Действие', function ($query) {
            $editBtn = "<a href='" . route('admin.gallery.edit', $query->id) . "' class='btn btn-primary'><i class='far fa-edit'></i></a>";
            $deleteBtn = "<a href='" . route('admin.gallery.delete', $query->id) . "' class='btn btn-danger ml-2 delete-item'><i class='far fa-trash-alt'></i></a>";
            $moreBtn = "<a href='".route('admin.gallery-images.index', ['gallery' => $query->id]). "' class='btn btn-info ml-2'><i class='far fa-image'></i></a>";
