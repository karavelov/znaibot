...
class BlogSubCategoryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('Действие', function($query){
            $editBtn = "<a href='".route('admin.blog-sub-category.edit', $query->id)."' class='btn btn-primary'><i class='far fa-edit'></i></a>";
            $deleteBtn = "<a href='".route('admin.blog-sub-category.delete', $query->id)."' class='btn btn-danger ml-2 delete-item'><i class='far fa-trash-alt'></i></a>";
        ...
        ->addColumn('Главна_категория', function($query) {
    ...
    {
        return $this->builder()
                    ->setTableId('blogsubcategory-table')
