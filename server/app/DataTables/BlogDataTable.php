...
class BlogDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('Действие', function($query){
                ...
                $deleteBtn = "<a href='".route('admin.blog.delete', $query->id)."' class='btn btn-danger ml-2 delete-item'><i class='far fa-trash-alt'></i></a>";
            ...
            ->addColumn('Категория', function($query){
                return $query->category->name;
            })
            ->addColumn('Дата_на_публикуване', function($query){
            ...
            ->rawColumns(['Действие', 'Изображение', 'Статус'])
            ->setRowId('id');
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('id'),
            Column::make('Изображение'),
            Column::make('title')->title('Заглавие'),
            Column::make('Категория'),
            Column::make('Статус'),
            Column::make('Дата_на_публикуване'),
